...
public class DisplayBoard : MonoBehaviour, IPointerDownHandler, IPointerClickHandler
{
    ...
    {
        if (curCell.pos.First == -1 && cellsDisplayed[go].owner == Owners.Player)//������� ����� �� �� ����������� ��� ���� (���� ��� ����������� ������, �� ��� ����� ����� �������)
        {
            curCell = cellsDisplayed[go];//��� ���������� �������
        }
        else if ((curCell.pos.First == cellsDisplayed[go].pos.First) && (curCell.pos.Second == cellsDisplayed[go].pos.Second))//�������, ����� �� ����� �� ��� ��������� ����, ���� ��, �� ��� ����� ������������
        {
            curCell = new Cell();
        ...
        else if (curCell.pos.First >= 0 && cellsDisplayed[go].owner == Owners.Neutral) //�������, ����� �� �� ���� ��������
        {
